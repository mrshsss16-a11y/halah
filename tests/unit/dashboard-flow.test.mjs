...
async function main() {
  ...
  // شريط «منتجاتي» اختُصر 2026-09-17 (طلب المالك: أزرار أقصر) — الصياغة التفصيلية «يُكمَل يوماً بيوم»
  // انتقلت لنافذة التقدّم (bulk.js)، والشريط نفسه يكتفي بـ«يُؤجَّل تلقائياً».
  assert(/الزائد عن حد اليوم يُؤجَّل تلقائياً/.test(visible) && /كل ~١٠ دقائق/.test(bulk),
    "FLOW-2: الزائد عن حد اليوم يُقال إنه مؤجَّل، وتفصيل الدفعات الدورية موجود بنافذة التقدّم");
