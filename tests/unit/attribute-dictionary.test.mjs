...
async function main() {
  ...
  }
  {
    ...
    assert(/بليسيه ≠ كسرات عريضة/.test(blocks[7]) && /قصّة مستقيمة ≠ واسعة/.test(blocks[7]) && /سطح القماش: لامع/.test(blocks[7]) && !/بطيّات \(بليسيه\)/.test(blocks[7]), "AD-6b: البليسيه يُميَّز عن الكسرات العريضة، ولمعان القماش صفة مرئية (تنورة حقيقية 2026-09-12)");
