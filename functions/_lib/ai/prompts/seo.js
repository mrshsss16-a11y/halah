...
export const VISION_PROMPT = [
  ...
  "- اكتب الملاحظات أسطراً قصيرة، سطراً لكل جانب بهذا الترتيب: «اللون: …» «الياقة: …» «الأكمام: …» «التفاصيل: …» «الطول والقصّة: …». جانب لا يظهر بوضوح يُحذف سطره كاملاً، ولا يتناقض سطران.",
