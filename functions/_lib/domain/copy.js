...
function focusedDescriptionSystem(name, notes, variantsText) {
  return [
    ...
    "٣) إن وردت «الخيارات المتوفرة فعلاً» فجملة تذكر قيم كل خيار ورد فيها وحده بقيمه («يتوفر بالمقاسات من 36 إلى 44»)؛ لا ألوان إن لم يرد خيار لون، ولا وصف للقائمة نفسها («المسجلة»، «تحت الخيارات»، «ألوان المتجر»)، ولا إحالة لجدول أو قياسات ولا «اختاري المقاس المناسب» (2026-09-15)؛ وإلا فقرتان تكفيان.",
    "ممنوع: السعر، الشحن والإرجاع والدفع، أي خامة لم ترد، أحكام الجودة (مريح، أنيق، أناقة، فاخر، فخامة، مثالي، راقٍ)، ذكر العارضة أو الصورة أو «النموذج المعروض» أو «يظهر التصميم»، وأي تفصيل لم يرد بالملاحظات.",
