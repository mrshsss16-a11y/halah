...
const ENUMS = {
  ...
  details: ["كسرات عريضة", "بليسيه", "طبقات", "كشكش", "دانتيل", "تطريز", "ترتر", "خرز", "فتحة جانبية", "أزرار", "جيوب", "حزام", "رباط", "درابيه", "تصميم غير متماثل", "سحاب ظاهر", "سموك", "كاب", "تخريم"],
...
const DETAIL_ALIASES = { "تطريز": ["تطريز", "مطرز"], "ترتر": ["ترتر", "مترتر"], "خرز": ["خرز", "مخرز"], "كشكش": ["كشكش", "مكشكش"], "كسرات عريضة": ["كسرات", "كسره"], "طبقات": ["طبقات", "طبقه"], "فتحة جانبية": ["فتحه"], "أزرار": ["ازرار"], "جيوب": ["جيوب", "جيب"], "تصميم غير متماثل": ["غير متماثل"], "سحاب ظاهر": ["سحاب"], "كاب": ["كاب", "كيب"], "تخريم": ["تخريم", "مخرم", "كروشيه"] };
...
export function structuredVisionBlock(ctx, name = "") {
  ...
  return [
    ...
    "- color: إن كان بالقطعة لونان رئيسيان (كاروهات أو مخطط أو قطعتان أو ألواح بلون مختلف داخل القطعة) اذكرهما معاً «أحمر وأسود»، لا الأوضح وحده.",
